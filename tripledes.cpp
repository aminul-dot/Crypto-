...
int main(int argc, char* argv[]) {
    ...
    byte key[ CryptoPP::DES_EDE2::DEFAULT_KEYLENGTH ], iv[ CryptoPP::DES_EDE2::BLOCKSIZE ];
    memset( key, 0x00, CryptoPP::DES_EDE2::DEFAULT_KEYLENGTH );
    ...
    CryptoPP::DES_EDE2::Encryption desEncryption(key, CryptoPP::DES_EDE2::DEFAULT_KEYLENGTH);
   ...
   // }
    ...
    CryptoPP::DES_EDE2::Decryption desDecryption(key, CryptoPP::DES_EDE2::DEFAULT_KEYLENGTH);
